...
| [mv](mv/) | Unix-style move with pattern support — Rename() on the same volume, copy+delete across volumes, skip or OVERWRITE on collisions. In both Amiga E and 68k assembly. |
