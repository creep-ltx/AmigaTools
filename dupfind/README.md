...
recursive directory scanning should be exercised on AmigaOS itself
(real hardware or an emulator) before trusting the results.

## Verified behaviour

`dupfind` has been run against an AmigaOS 3.2 install (FS-UAE, 762 files) in
