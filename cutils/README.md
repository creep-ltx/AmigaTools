...
carries a single **pack version** of its own — pack 0.1.1 =
ls 0.3.4 / cp 0.1.2 / mv 0.5 / mkdir 0.1.1 / rm 0.1 (pack 0.1.0
shipped ls 0.3.3, before the PFS3 `-R` fix) — bumped whenever the
archive is repacked with newer commands. Per-command reference docs live in
